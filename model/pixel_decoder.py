...
def build_pixel_decoder(args):
    input_shape = {}
    for idx, in_feature in enumerate(args.in_features):
        input_shape[in_feature] = ShapeSpec()
        input_shape[in_feature].channels = args.in_channels[idx]
        input_shape[in_feature].height = None
        input_shape[in_feature].width = None
        input_shape[in_feature].stride = args.in_strides[idx]

    pixel_decoder = TransformerEncoderPixelDecoder(input_shape=input_shape, \
                                                   transformer_dropout=args.transformer_dropout, \
                                                   transformer_nheads=args.transformer_nheads, \
                                                   transformer_dim_feedforward=args.transformer_dim_feedforward, \
                                                   transformer_enc_layers=args.transformer_enc_layers, \
                                                   transformer_pre_norm=args.transformer_pre_norm, \
